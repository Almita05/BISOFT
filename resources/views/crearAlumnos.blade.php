...
<div class="modal fade" id="modalAlumno" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3" id="divSemestres" style="display:none;">
    ...
    <select class="form-control" name="trimestre">
        ...
        <option value="6">6to trimestre</option>
    </select>
</div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // CAMBIO DE GENERACIÓN → CARGA GRUPOS
    ...
    // ✅ MOSTRAR / OCULTAR TRIMESTRES
    document.getElementById("chkEquivalencia").addEventListener("change", function() {
        let div = document.getElementById("divSemestres");
