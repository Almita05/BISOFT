...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item">
                ...
                <span class="nav-link collapsed d-flex justify-content-between align-items-center"
                    data-bs-toggle="collapse" data-bs-target="#submenu-alumnos"
                ...
                <!-- SUBMENU -->
                <div class="multi-level collapse {{ Request::is('users*') ? 'show' : '' }}" id="submenu-alumnos"
                ...
                <div class="multi-level collapse {{ Request::is('users*') ? 'show' : '' }}" id="submenu-alumnos-1"
                    data-bs-parent="#sidebarMenu">

                    <ul class="flex-column nav">

                        <!-- CALIFICACIONES -->
                        <li class="nav-item {{ Request::is('users/calificaciones') ? 'active' : '' }}">
                            <a href="/users/calificaciones" class="nav-link">
                                <i class="bi bi-file-earmark-spreadsheet-fill"></i>
                                <span class="sidebar-text">Calificaciones</span>
                            </a>
                        </li>
            ...
            <li class="nav-item {{ Request::is('docentes*') ? 'active' : '' }}">
                ...
                <!-- SUBMENU -->
                <div class="multi-level collapse {{ Request::is('docentes*') ? 'show' : '' }}" id="submenu-docentes"
                    data-bs-parent="#sidebarMenu">
  ...
  <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5"/>
                                ...
                                <span class="sidebar-text">Alta Docentes</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('planes-de-estudio') ? 'active' : '' }}">
                            <a class="nav-link" href="/planes-de-estudio">
                        ...
                        <li class="nav-item {{ Request::is('planes-bti') ? 'active' : '' }}">
                            <a class="nav-link" href="/planes-bti">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-file-earmark-pdf-fill" viewBox="0 0 16 16">
                                    <path
                                        d="M5.523 12.424q.21-.124.459-.238a8 8 0 0 1-.45.606c-.28.337-.498.516-.635.572l-.035.012a.3.3 0 0 1-.026-.044c-.056-.11-.054-.216.04-.36.106-.165.319-.354.647-.548m2.455-1.647q-.178.037-.356.078a21 21 0 0 0 .5-1.05 12 12 0 0 0 .51.858q-.326.048-.654.114m2.525.939a4 4 0 0 1-.435-.41q.344.007.612.054c.317.057.466.147.518.209a.1.1 0 0 1 .026.064.44.44 0 0 1-.06.2.3.3 0 0 1-.094.124.1.1 0 0 1-.069.015c-.09-.003-.258-.066-.498-.256M8.278 6.97c-.04.244-.108.524-.2.829a5 5 0 0 1-.089-.346c-.076-.353-.087-.63-.046-.822.038-.177.11-.248.196-.283a.5.5 0 0 1 .145-.04c.013.03.028.092.032.198q.008.183-.038.465z" />
            ...
            <!-- GRUPOS -->
            <li class="nav-item {{ Request::segment(1) == 'grupos' ? 'active' : '' }}">
            ...
            <li class="nav-item {{ Request::segment(1) == 'equivalencias' ? 'active' : '' }}">
            ...
            <li class="nav-item">
                ...
                <a href="/logout" class="btn btn-info d-flex align-items-center justify-content-center btn-upgrade-pro">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
